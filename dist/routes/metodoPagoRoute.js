...
metodoPagoRoute.post("/crearMetodo", [auth_1.verificaToken], (req, resp) => {
    const crearMetodo = new metodoPagoClass_1.MetodoPagoClass();
    crearMetodo.crearMetodoPago(req, resp);
});
metodoPagoRoute.put("/editarMetodo", [auth_1.verificaToken], (req, resp) => {
...
metodoPagoRoute.delete("/eliminarMetodoID", [auth_1.verificaToken], (req, resp) => {
