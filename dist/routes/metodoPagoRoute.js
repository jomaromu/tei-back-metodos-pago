...
metodoPagoRoute.get("/obtenerTododsMetodosCriterio", [auth_1.verificaToken], (req, resp) => {
    const obtenerTododsMetodosCriterio = new metodoPagoClass_1.MetodoPagoClass();
